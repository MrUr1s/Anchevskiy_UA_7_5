...
public class GameManager : MonoBehaviour
{
    ...
    private IEnumerator Move(BaseClickComponent component, ChipComponent enemy=null)
    {
        ...
        //while (Vector3.Distance(_selectChip.transform.localPosition, component.transform.localPosition)>=0f)
        while (_selectChip.transform.localPosition!=component.transform.localPosition)
            {
